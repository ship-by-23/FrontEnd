...
export function SearchPage() {
  ...
  const result = useQuery({ queryKey: ["article-search", queryText], queryFn: ({ signal }) => apiRequest<ArticleCollection>(`/articles?${new URLSearchParams({ query: queryText, page: "1", pageSize: "20" })}`, { signal }), enabled: queryText.length > 0 });
